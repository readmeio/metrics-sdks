"""
Django settings for metrics_django project.
...
SECRET_KEY = "django-insecure-*_s5(j$d2l4)n)d13)%6pf)#m32g((jm+4v@%yy9%3gro*&gty"
...
WSGI_APPLICATION = "metrics_django.wsgi.application"
