...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'developers/4.465.0 (api/6.1.0)');
  }
   ...
   */
  createCategory(
    body: types.CreateCategoryBodyParam,
   ...
   */
  updateCategory(
    body: types.UpdateCategoryBodyParam,
   ...
   */
  updateChangelog(
    body: types.UpdateChangelogBodyParam,
   ...
   */
  updateCustomPage(
    body: types.UpdateCustomPageBodyParam,
   ...
   */
  updateDoc(
    body: types.UpdateDocBodyParam,
    metadata: types.UpdateDocMetadataParam
  ): Promise<FetchResponse<200, types.UpdateDocResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.GetProductionDocResponse200>> {
   ...
   */
  updateVersion(
    body: types.UpdateVersionBodyParam,
...
export type {
  ...
  UploadApiSpecificationResponse408,
} from './types';
