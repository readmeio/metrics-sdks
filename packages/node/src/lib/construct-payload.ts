...
export interface LogOptions {
  ...
  /**
   * If true, this will return the log details without waiting for a response from the ReadMe
   * Metrics servers.
   */
...
export interface PayloadData {
  ...
  /**
   * Object or string | The incoming request body. You should provide this function a parsed
   * object, but a string is acceptable if necessary.
   */
