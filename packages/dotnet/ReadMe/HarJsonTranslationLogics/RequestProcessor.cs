...
namespace ReadMe.HarJsonTranslationLogics
{
    class RequestProcessor
    {
        ...
        public async Task<Request> ProcessRequest()
        {
            ...
            requestObj.headers = RedactionHelper.RedactHeaderDictionary(
            ...
            requestObj.url = this.request.Scheme + "://" + this.request.Host.Host + ":" + this.request.Host.Port +
                             this.request.Path;
        ...
        private async Task<PostData> GetPostData()
        {
            ...
            else if (RedactionHelper.IsApplicationJson(this.request.ContentType))
            {
                ...
                postData.text = redactedJson.ToString();
            }
